    ...
    return (
      <div className="container">
        ...
        <p className="text-left">
          ...
          <br/>
          <br/>
          The issue with existing trail reporting is a lack of real-time information. The only way to know the conditions on any given trail at any given time is to actually ski down the run. What this means is that if a trail is really iced up or has poor snow coverage, you won’t know until you are already on your way down the mountain, and at that point, it is too late to turn back.
          <br/>
          <br/>
